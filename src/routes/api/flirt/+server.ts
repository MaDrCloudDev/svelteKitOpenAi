			...
			'https://api-inference.huggingface.co/models/meta-llama/Llama-3.2-1B-Instruct/v1/chat/completions',
			{
				...
				body: JSON.stringify({
					...
					messages: [
						{
							role: 'system',
							content: 'You are a charming, witty, and playfully flirty conversation partner. Keep responses natural, engaging, and fun while being respectful. Use casual language, light humor, and just the right amount of playful teasing to keep things interesting.'
						},
						{
							role: 'user',
							content: message
