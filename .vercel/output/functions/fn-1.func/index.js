  ...
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    ...
    Hamburger = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<button aria-label="${"Open menu"}" class="${[
        "text-[#7f7d76] hover:text-[#fffb00] md:hidden cursor-pointer mr-4 border-none focus:outline-none svelte-1prbcdr",
        open ? "open" : ""
    ...
    Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      do {
        $$settled = true;
        $$rendered = `<header class="${"sticky top-0 z-50 bg-black text-[#7f7d76]"}"><div class="${"pb-2 flex-grow max-w-2xl mx-auto"}"><ul class="${"flex items-center justify-between"}"><li class="${"ml-2"}"><a href="${"https://madr.io/"}" aria-label="${"MaDr Logo"}">${validate_component(LogoNav, "LogoNav").$$render($$result, {}, {}, {})}</a></li>
			<div class="${"w-full justify-around max-w-2xl mx-auto text-xl hidden md:flex"}"><li class="${"hover:text-[#fffb00]"}"><a href="${"https://madr.io/about/"}"${add_classes(($page.url.pathname == "/about" ? "active" : "").trim())}>About</a></li>
				<li class="${"hover:text-[#fffb00]"}"><a href="${"https://madr.io/tech/"}"${add_classes(($page.url.pathname == "/tech" ? "active" : "").trim())}>Tech</a></li>
				<li class="${"hover:text-[#fffb00]"}"><a href="${"https://madr.io/projects/"}"${add_classes(($page.url.pathname == "/projects" ? "active" : "").trim())}>Projects</a></li>
				<li class="${"hover:text-[#fffb00]"}"><a href="${"https://madr.io/weather/"}"${add_classes(($page.url.pathname == "/weather" ? "active" : "").trim())}>Weather?</a></li>
				<li class="${"hover:text-[#fffb00]"}"><a href="${"/"}"${add_classes(($page.url.pathname == "/" ? "active" : "").trim())}>Robot?</a></li>
				<li class="${"hover:text-[#fffb00]"}"><a href="${"https://madr.io/contact"}"${add_classes(($page.url.pathname == "/contact" ? "active" : "").trim())}>Contact</a></li>
				

				<li class="${"hover:text-[#fffb00]"}"><a href="${"https://madr.io/login"}"${add_classes(($page.url.pathname == "/login" ? "active" : "").trim())}>Login</a></li></div>
			<li>${validate_component(Hamburger, "Hamburger").$$render(
          $$result,
          { open: sidebar },
          {
            open: ($$value) => {
    ...
    css = {
      code: "aside.svelte-154h4xq{left:-100%;transition:left 0.3s ease-in-out}.open.svelte-154h4xq{left:0}",
      map: null
    };
    Sidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_page();
      return `<aside class="${[
        "fixed w-full h-full bg-black shadow-lg text-3xl text-center z-50 svelte-154h4xq",
        open ? "open" : ""
      ].join(" ").trim()}"><ul class="${"flex flex-col gap-6 content"}"><li class="${"hover:text-[#fffb00] mb-3"}"><a href="${"https://madr.io/about/"}"${add_classes(($page.url.pathname == "/about" ? "active" : "").trim())}>About</a></li>
		<li class="${"hover:text-[#fffb00] mb-3"}"><a href="${"https://madr.io/tech/"}"${add_classes(($page.url.pathname == "https://madr.io/tech/" ? "active" : "").trim())}>Tech</a></li>
		<li class="${"hover:text-[#fffb00] mb-3"}"><a href="${"https://madr.io/projects/"}"${add_classes(($page.url.pathname == "https://madr.io/projects/" ? "active" : "").trim())}>Projects</a></li>
		<li class="${"hover:text-[#fffb00] mb-3"}"><a href="${"https://madr.io/contact/"}"${add_classes(($page.url.pathname == "https://madr.io/contact/" ? "active" : "").trim())}>Contact</a></li>
		<li class="${"hover:text-[#fffb00] mb-3"}"><a href="${"https://madr.io/weather/"}"${add_classes(($page.url.pathname == "https://madr.io/weather/" ? "active" : "").trim())}>Weather?</a></li>
		<li class="${"hover:text-[#fffb00]"}"><a href="${"https://flirtatiousai.madr.io/"}"${add_classes(($page.url.pathname == "/" ? "active" : "").trim())}>Robot?</a></li>
		<li class="${"hover:text-[#fffb00] mb-3"}"><a href="${"https://madr.io/login/"}"${add_classes(($page.url.pathname == "https://madr.io/login/" ? "active" : "").trim())}>Login</a></li>
		<li class="${"mx-auto"}"><a href="${"https://madr.io/"}"${add_classes(($page.url.pathname == "https://madr.io/" ? "active" : "").trim())}>${validate_component(LogoBW, "LogoBW").$$render($$result, {}, {}, {})}</a></li></ul>
</aside>`;
    });
...
<div class="${"flex flex-col items-center px-4"}">${slots.default ? slots.default({}) : ``}</div>
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/entry/_layout.svelte.9a608edb.js";
    imports = ["_app/immutable/entry/_layout.svelte.9a608edb.js", "_app/immutable/chunks/index.a822744d.js", "_app/immutable/chunks/singletons.10a7c44e.js", "_app/immutable/chunks/stores.16903a82.js"];
    stylesheets = ["_app/immutable/assets/_layout.3d1cbeca.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    file2 = "_app/immutable/entry/error.svelte.e05d43c7.js";
    imports2 = ["_app/immutable/entry/error.svelte.e05d43c7.js", "_app/immutable/chunks/index.a822744d.js", "_app/immutable/chunks/stores.16903a82.js", "_app/immutable/chunks/singletons.10a7c44e.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/TemplateTag/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/trimResultTransformer/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/stripIndentTransformer/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/replaceResultTransformer/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/replaceSubstitutionTransformer/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/replaceStringTransformer/replaceStringTransformer.js
var init_replaceStringTransformer = __esm({
  "node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/replaceStringTransformer/replaceStringTransformer.js"() {
  }
});

// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/replaceStringTransformer/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/inlineArrayTransformer/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/splitStringTransformer/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/removeNonPrintingValuesTransformer/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/commaLists/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/commaListsAnd/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/commaListsOr/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/html/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/codeBlock/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/source/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/safeHtml/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/oneLine/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/oneLineTrim/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/oneLineCommaLists/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/oneLineCommaListsOr/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/oneLineCommaListsAnd/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/inlineLists/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/oneLineInlineLists/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/stripIndent/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/stripIndents/index.js
...
// node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/index.js
var init_es = __esm({
  "node_modules/.pnpm/common-tags@1.8.2/node_modules/common-tags/es/index.js"() {
    init_TemplateTag2();
    init_trimResultTransformer2();
  ...
  ".svelte-kit/output/server/entries/endpoints/api/flirt/_server.ts.js"() {
    ...
    POST = async ({ request }) => {
      try {
        ...
        ${oneLine_default`
        You are a flirtatious human who finds everyone attractive and interesting. Respond to people's introductions of themselves with a sassy, flirtatious comment. Mention their feet.
        `}
